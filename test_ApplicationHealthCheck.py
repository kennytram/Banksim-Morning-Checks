...
class TestApplicationHealthCheck(TestCase):
    def setUp(self):
        ...
        self.app_health_check = ApplicationHealthCheck(self.base_dir, self.business_date)
...
class TestCRSHealthCheck(TestCase):
    ...
    def test_calculate_received(self, MockFileChecker):
        mock_file_checker = MockFileChecker.return_value
        mock_file_checker.count_csv_rows_matching_files_matching_columns.return_value = 20
